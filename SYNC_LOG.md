...
| `KICH_BAN_1A_core.md` | **v0.2.2-draft** | 2026-05-15 | 📝 Draft đầy đủ (chờ duyệt) |
...
| `LUAT_2A_core.md` | **v0.2.4-draft** | 2026-05-15 | 📝 Draft đầy đủ (chờ duyệt) |
| `LUAT_2B_llm.md` | **v0.1.2-draft** | 2026-05-15 | 📝 Draft đầy đủ (chờ duyệt) |
| `LUAT_2C_infra.md` | **v0.1.4-draft** | 2026-05-15 | 📝 Draft đầy đủ (chờ duyệt) |
