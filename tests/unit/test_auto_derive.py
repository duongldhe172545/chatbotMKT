"""Test auto_derive — LLM-driven main_category.

Refer:
- F2B.7 (LUAT_2B_llm) — auto-derive
- feedback_no_case_lock memory — KHÔNG substring keyword match
(2026-06-24) Đã bỏ test gen brand_short/initials/slogan — tàn dư luồng tự-gen-logo cũ.
"""
